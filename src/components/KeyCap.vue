...
const emit = defineEmits(['selected', 'matrix-click'])

const onCapClick = (e: MouseEvent) => {
  emit('matrix-click', { keyIndex: props.keyIndex, event: e })
}
...
.keyborder {
  ...
  background: #63656b;
  // background-image: url('../assets/keycaptophighlight.png'); // REMOVED ASSET
